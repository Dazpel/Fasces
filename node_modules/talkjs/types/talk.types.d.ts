...
export declare interface Chatbox extends UIBox {
     ...
     *
     * @remarks
     * `conversation`,  can be either a {@link Conversation} object or a TalkJS
     * conversation id.
     */
...
export declare interface ChatboxOptions {
     ...
     *
     * @deprecated We recommend using {@link MessageField.setText} right after mounting the chatbox to precisely control when message suggestions are shown.
     */
...
export declare interface Inbox extends UIBox {
     ...
     * `conversation`, which can be either a {@link Conversation} object or a TalkJS
     * conversation id.
     */
    select(conversation: string | Conversation | ConversationBuilder): void;
    /**
...
export declare interface MessageField {
     ...
     * with a given text showing immediately, consider passing {@link InboxOptions.messageSuggestion} to
     * {@link Session.createInbox} (or `createPopup` or `createChatbox`).
     *
 ...
 */
declare interface TranslationToggledEvent {
    /**
